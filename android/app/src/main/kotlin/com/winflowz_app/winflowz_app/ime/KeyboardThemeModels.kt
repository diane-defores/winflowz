...
data class KeyboardThemeConfig(
    ...
    fun toMap(): Map<String, Any?> {
        return mapOf(
            ...
            "keyWidthScale" to keyWidthScale,
    ...
    fun validated(): KeyboardThemeConfig {
        ...
        return copy(
            ...
            keyWidthScale = keyWidthScale.coerceIn(0.75f, 1f),
            ...
            return runCatching {
                ...
                fromMap(
                    mapOf(
                        ...
                        "keyWidthScale" to json.optDouble("keyWidthScale", 1.0),
        ...
        fun fromMap(raw: Map<*, *>): KeyboardThemeConfig {
            val config =
                KeyboardThemeConfig(
                    ...
                    keyWidthScale = (raw["keyWidthScale"] as? Number)?.toFloat() ?: 1f,

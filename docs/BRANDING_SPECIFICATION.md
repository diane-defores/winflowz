...
| Name | Hex | RGB | Usage |
|------|-----|-----|-------|
| Red | `#ff0033` | rgb(255, 0, 51) | Gradient start, accent |
| Magenta | `#ff00c8` | rgb(255, 0, 200) | Gradient, glow |
| Yellow | `#ffe500` | rgb(255, 229, 0) | Gradient, highlights |
| Green | `#00ff44` | rgb(0, 255, 68) | Gradient, success |
| Cyan | `#00c8ff` | rgb(0, 200, 255) | Gradient, links |

### Logo Gradient Colors
| Name | Hex | Usage |
|------|-----|-------|
| Gold | `#ffb200` | Logo gradient start |
| Magenta | `#e10057` | Logo gradient middle |
| Deep Purple | `#5A1A80` | Logo gradient end |

### UI Colors - Tailwind Configuration
...
orange: {
  ...
  300: "#fb713b",   // Primary orange
  400: "#ff57db",   // Rose/Pink accent
  500: "#009427",   // Green (semantic override)
  600: "#ff57db",   // Rose/Pink accent
}
```
...
#### Dark Mode
```css
--sl-color-accent: #ffcba2;      /* Warm peach */
--sl-color-accent-high: #ffe96e; /* Bright yellow */
--sl-color-accent-low: #ff9c45;  /* Deep orange */
...
#### Light Mode
```css
--sl-color-accent: #ffa375;      /* Soft coral */
--sl-color-accent-high: #241203; /* Deep brown */
--sl-color-accent-low: #ffa057;  /* Orange */
--sl-color-black: #fff;          /* Inverted */
...
--sl-color-white: #181818;       /* Inverted */
...
|---------|------------|-----------|
| Body | `#ffffff` | `bg-neutral-900` |
| Navbar | `bg-white/60` | `bg-neutral-800/80` |
| Cards | `bg-white` | `bg-neutral-800` |
| Overlay | `#f6f6f699` | `#272727cc` |
...
/* Tip */
.starlight-aside--tip {
  background: linear-gradient(45deg, #ff9c88, #ffc97c);
  color: #66350c;
...
### Key Brand Colors
```
Primary Gradient: #ffb200 → #e10057 → #5A1A80
Rainbow: #ff0033 → #ff00c8 → #ffe500 → #00ff44 → #00c8ff
Accent: #ffcba2 (dark), #ffa375 (light)
Orange CTA: #fb713b / bg-orange-500
```

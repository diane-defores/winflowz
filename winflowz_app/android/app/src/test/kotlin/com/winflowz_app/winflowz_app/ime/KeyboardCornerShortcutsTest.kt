...
class KeyboardCornerShortcutsTest {
    ...
    fun `smart french corners are the default preset`() {
        ...
        assertEquals("Fin", rKey.cornerAssignments.down?.label)
        ...
        assertEquals("Début", uKey.cornerAssignments.down?.label)
        assertEquals("Paste", pKey.cornerAssignments.topLeft?.label)
        assertEquals("/", pKey.cornerAssignments.bottomRight?.label)
        assertEquals("Word←", oKey.cornerAssignments.left?.label)
        assertEquals("DelW→", oKey.cornerAssignments.right?.label)
        ...
        assertEquals("DelW←", zKey.cornerAssignments.left?.label)
        assertEquals("Word→", zKey.cornerAssignments.right?.label)
        ...
        assertEquals("/", pKey.cornerAssignments.bottomRight?.value?.text)
        assertEquals(KeyboardKeyAction.NavigateWordLeft, oKey.cornerAssignments.left?.value?.action)
        assertEquals(KeyboardKeyAction.DeleteWordAfter, oKey.cornerAssignments.right?.value?.action)
        assertEquals(KeyboardKeyAction.NavigateLineStart, uKey.cornerAssignments.down?.value?.action)
        assertEquals(KeyboardKeyAction.NavigateLineEnd, rKey.cornerAssignments.down?.value?.action)
        assertEquals(KeyboardKeyAction.DeleteWordBefore, zKey.cornerAssignments.left?.value?.action)
        assertEquals(KeyboardKeyAction.NavigateWordRight, zKey.cornerAssignments.right?.value?.action)

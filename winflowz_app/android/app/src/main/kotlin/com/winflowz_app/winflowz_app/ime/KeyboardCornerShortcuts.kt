...
object KeyboardCornerPresets {
    ...
    private fun punctuationShortcuts(): List<KeyboardCornerShortcut> {
        return listOf(
            ...
            shortcut("letter-g", KeyboardCornerSlot.Down, "action:NavigateWordLeft", label = "W←"),
            shortcut("letter-h", KeyboardCornerSlot.Up, "6"),
            shortcut("letter-h", KeyboardCornerSlot.Down, "action:NavigateWordRight", label = "W→"),
            shortcut("letter-x", KeyboardCornerSlot.Up, "7"),
            shortcut("letter-c", KeyboardCornerSlot.Up, "8"),
            shortcut("letter-c", KeyboardCornerSlot.Down, "action:NavigateWordLeft", label = "<-W"),
            shortcut("letter-v", KeyboardCornerSlot.Up, "9"),
            shortcut("letter-v", KeyboardCornerSlot.Down, "action:NavigateWordRight", label = "->W"),
            shortcut("letter-b", KeyboardCornerSlot.Up, "0"),
            shortcut("letter-b", KeyboardCornerSlot.BottomRight, "/", label = "/"),
            shortcut("letter-a", KeyboardCornerSlot.TopRight, "@"),
            shortcut("letter-p", KeyboardCornerSlot.TopLeft, "action:PasteClipboard", label = "📋"),
            shortcut("letter-t", KeyboardCornerSlot.Down, "action:NavigateLineEnd", label = "Fin"),
            shortcut("letter-y", KeyboardCornerSlot.Down, "action:NavigateLineStart", label = "Début"),
            shortcut("letter-r", KeyboardCornerSlot.Down, "action:NavigateLineDown", label = "↓"),
            shortcut(
                "letter-e",

...
🟡 [WinFlowzApp] audit: Flutter dependencies and supply chain | date: 2026-06-12 | overall: B- | issues: no current OSV advisories for direct pub deps; main risk is stale Firebase or Supabase runtime packages, missing project license declaration, and weak explicit Flutter or Dart pinning outside Flox | scope: dependencies

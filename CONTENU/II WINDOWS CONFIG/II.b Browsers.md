...
[(25) Why Firefox Is Dead (The Many Mistakes Of Mozilla) - YouTube](https://www.youtube.com/watch?v=X5YPjNKR3iM)
## How Vivaldi can change the way we browse
...
- 👥 Vivaldi a une communauté active de bénévoles du monde entier qui contribuent à tester, traduire et promouvoir le navigateur.

- 🌍 L'équipe Vivaldi est composée de personnes de 25 nationalités différentes, travaillant dans des bureaux en Norvège, en Islande et aux États-Unis.

- 🏡 Le siège social de Vivaldi est situé à Oslo, près d'une cascade, offrant une vue inspirante pour concevoir le navigateur.

- 👷‍♂️ Vivaldi appartient à ses employés et n'a pas d'investisseurs externes, leur donnant la liberté d'écouter les utilisateurs et de concevoir le navigateur qu'ils méritent.

- 📈 Vivaldi compte plus de 3 millions d'utilisateurs actifs et plus de 1,6 million de membres dans sa communauté.

- 🤝 Vivaldi encourage l'auto-organisation et la collaboration entre les départements et les projets pour un développement efficace.
[Ce en quoi nous croyons | Navigateur Vivaldi](https://vivaldi.com/fr/company/#locations)


- 🔑 Vivaldi believes in giving users choice and customization options in their browser, unlike Apple's "you're holding it wrong" stance with the iPhone 4's antenna issues.

- 👨‍👩‍👧‍👦 Vivaldi's user-centric approach actively engages with users to understand their needs and drive the development of new features and improvements.

- 🔧 Vivaldi offers extensive customization options for aesthetics, functionality, keyboard shortcuts, and more, catering to both minimalists and power users.

- 🌈 Vivaldi embraces the philosophy of "Everything's an option!" allowing users to tailor their browsing experience to their unique preferences.

- 🙌 Vivaldi prioritizes transparency, collaboration, and a commitment to building products that put users first, in contrast to Apple's initial response to the antenna issue.

- 🚀 Vivaldi continuously incorporates user-requested upgrades, as shown in the latest Vivaldi 6.6 release, demonstrating their dedication to user feedback.

### Development
- 🗣️ Vivaldi values user feedback as the main ingredient for improving the browsing experience.
- 🔍 Vivaldi initially made design changes to unify menus and toolbars across platforms, but some users were unhappy with the removal of certain features.
- 🌐 Vivaldi prioritizes showing the website URL prominently for security reasons.
- 👂 Instead of deflecting blame, Vivaldi listens to user concerns and adjusts their approach accordingly.
- ⚙️ Vivaldi reinstated the panel button and Home button setting on Android after user feedback.
- 📢 User feedback through social media, forums, and app reviews guides Vivaldi's future development.
- 🤝 Vivaldi sees their browser as a community effort, fostering an open dialogue with users.
- 💪 Continuous improvement through performance enhancements and bug fixes is a core goal.
- 🙌 Vivaldi encourages users to actively participate and share feedback to shape the browsing experience.
[Home | Vivaldi Forum](https://forum.vivaldi.net/)
- 🌐 Snapshots are work-in-progress builds that allow users to test new Vivaldi features before they are released in the Stable version.

- ⚠️ Snapshots may contain bugs or regressions, as they are the first public test of new features.

- 🔒 Stable versions are released every six weeks and introduce features that have been tested and polished in Snapshots, prioritizing security updates.

- 💻 On Linux and macOS, users can run Snapshot and Stable versions side by side, but on Windows, they need to install one or the other as a standalone version.

- 🔄 Switching from Snapshot to Stable could lead to a corrupted profile on some platforms, so caution is advised.

- 🌟 Stable versions are recommended for day-to-day browsing, while Snapshots are ideal for developers and advanced users who want to test new features and are patient with potential bugs.

- ⚖️ Both Snapshot and Stable versions have their advantages and disadvantages, and the choice depends on the user's preferences and willingness to deal with potential issues.
...
- It allows users to "Ask AI" on any web page, providing intelligent assistance and information directly related to the page content.
- The "Smart Tab & Download Renaming" feature utilizes AI to automatically rename tabs and downloaded files with more descriptive and meaningful names.
- Arc Max offers integration with ChatGPT, enabling users to access the powerful language model directly within the browser for various tasks.
- The suite of features aims to save users time and increase productivity by leveraging AI capabilities to streamline browsing-related activities.
- Users can easily enable Arc Max features through the command bar (Cmd + T) and select the desired options.
- Arc Max is part of the Arc browser ecosystem, which also includes Arc Search, developer resources, and a blog.
- The Arc browser is available for download on Windows 11, providing a platform for users to experience the AI-powered browsing enhancements offered by Arc Max.




[Google Chrome Statistics for 2024](https://backlinko.com/chrome-users#number-of-chrome-extensions)
...
Le texte parle de l'application "Shift" qui permet d'intégrer plusieurs comptes Google et Microsoft, des applications web, et des extensions dans une seule fenêtre pour une expérience en ligne simplifiée.


- Shift permet d'accéder à plusieurs comptes Google et Microsoft, d'intégrer des applications web et des extensions dans une seule fenêtre.
- Il propose des fonctionnalités telles que la gestion des comptes email, la création de Workspaces pour organiser les onglets et applications, et l'ajout d'extensions comme Boomerang, Grammarly, etc.
- Shift est disponible sur Mac et Windows, permettant de gérer les onglets efficacement et offrant une expérience de navigation plus fluide.
- L'application vise à simplifier l'expérience en ligne en regroupant tout ce dont l'utilisateur a besoin dans une seule interface.
...
- **Virtual Browsing**: Create a virtual environment on their servers and run the browser within it for secure browsing.
- **Unrestricted Access**: Bypass geo-restrictions and access content blocked in certain locations.
- **Online Privacy**: Browse anonymously and protect your online identity.
- **Website Compatibility Testing**: Test website compatibility with different browsers and devices.
- **Website Unblocking**: Access websites that are blocked on a network or by an organization.
- **Vulnerability Testing**: Test website security and identify vulnerabilities.
- **Incognito Research**: Conduct online research without leaving a digital footprint.
- **Ad-Free Browsing**: Enable ad-blocking and browse without ads.
...
Brave est un navigateur Web qui fait de **la protection des données personnelles de ses utilisateurs sa priorité**.

Ainsi pour renforcer la confidentialité de ses utilisateurs, il bloque l'ensemble des traceurs, des cookies, des pop-up ainsi que certains scripts publicitaires présents dans les pages Web. Il intègre également par défaut l'extension HTTPS Everywhere qui force l'utilisation du HTTPS sur tous les sites Internet pour chiffrer la connexion.

Vous avez la possibilité de changer le moteur de recherche utilisé par défaut (Qwant) et d'activer la navigation privée pour ne conserver aucun historique de votre navigation.

Grâce aux différentes options présentes pour protéger vos données, Brave propose en parallèle une navigation rapide et allégée des scripts inutiles ce qui vous permettra d'économiser de la batterie et des données de forfait mobile.

Si vous souhaitez en savoir plus sur cette application et la télécharger, cliquez-ici.

[How to Create Chrome AI Theme for Windows 11/10](https://www.thewindowsclub.com/how-to-create-chrome-ai-theme-for-windows)
### Panels is Life

Accède rapidement à tes applications utiles dans un panneau latéral. Voici la mienne :

_²_

Comme tu peux le voir, j'en ai beaucoup ! Tu peux choisir que les panneaux soient collants, ou qu'ils s'affichent lorsqu'on les clique à l'extérieur :

Tu peux rapidement accéder/réduire tous les panneaux avec la barre :

Tu verras des notifications sur tes applications (tu peux les désactiver).

Ce qui est vraiment cool avec les panneaux, c'est que tu peux choisir entre la version desktop et la version mobile, et tu peux définir une largeur spécifique pour chaque panneau !

[B- Outils organiser tabs et onglets](B-%20Outils%20organiser%20tabs%20et%20onglets.md)

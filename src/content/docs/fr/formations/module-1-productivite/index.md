...
En réalité : tu n'as pas encore décidé que cette chose mérite une place dans ton agenda. Le temps se crée, il ne se trouve pas.

**Mythe 2 : "Je n'ai pas la motivation"**
La motivation suit l'action, elle ne la précède pas. Segmente, commence petit, et laisse la dopamine faire son travail.
...
|--------|-------|---------|
| **Macro** | Vision, objectifs, système global | Planifier ses thèmes de la semaine |
| **Micro** | Exécution des tâches individuelles | Coupure des notifications pendant 45 min |
...
1. **La productivité** — fondements et état d'esprit *(ce module)*
2. **Windows** — configurer ton environnement de travail
3. **Temps & Énergie** — travailler avec ta biologie, pas contre elle
4. **Gestion des actions** — de l'intention à l'exécution
5. **Consommer** — filtrer l'information, reprendre la main
6. **Connaissances** — capturer, organiser, retrouver
...
| Focus | Ce qu'il couvre |
|-------|----------------|
| **FOCUS 1 — Optimisation business** | Stratégie, process, offre, expérience client, automatisation |
| **FOCUS 2 — Création de contenu** | Marque, vidéo, podcast, social media, newsletter |
| **FOCUS 3 — Accomplissement des tâches** | Admin, emails, prospection, développement réseau |
...
Planifier le pire libère l'énergie mentale. Quand tu as un plan B pour les situations critiques, ton cerveau cesse de ruminer et libère de la bande passante pour le travail créatif.

> "Flow is achieved best under the right amount of pressure and security."

**Domaines à sécuriser :**
- **Finances** — combien de mois peux-tu tenir sans revenu ? Quel est ton seuil de survie ?
- **Projets** — que se passe-t-il si ton client principal part ? Si ton lancement échoue ?
- **Rendez-vous** — que fais-tu si un prospect annule ? Si ta démo plante ?
...
Un système qui :
- Capture tout ce qui doit être fait sans encombrer ton cerveau

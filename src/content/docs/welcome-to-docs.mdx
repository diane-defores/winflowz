...
hero:
  ...
  image:
      alt: A WinFlowz's Logo
      dark: ../../images/starlight/winflowz_hero.svg
      light: ../../images/starlight/winflowz_hero.svg
  actions:
    - text: Get started
      icon: right-arrow
      variant: primary
...
<CardGrid stagger>
  ...
  <Card title="Tools & Equipment" icon="seti:eslint">
    Discover the complete lineup of WinFlowz's superior quality tools and equipment. Each subsection offers detailed specifications, usage instructions, and maintenance tips.
  </Card>
